...
from AppFullSailing.models import Alumno, Profesor, Examen, Avatar
from AppFullSailing.forms import AlumnosFormulario, ProfesoresFormulario, ExamenesFormulario, UserRegisterForm, UserEditForm, AvatarFormulario
